...
start_http_server(PrivDir, Port, HttpRestConfig) ->
   Dispatch = cowboy_router:compile([
      {'_', [
        ...
        {"/ide/bundle.js", beamparticle_compress_handler,
         [{file, PrivDir ++ "/ide/bundle.js"}, {type, js}]},
        {"/ide/vs/editor/editor.main.js", beamparticle_compress_handler,
         [{file, PrivDir ++ "/ide/vs/editor/editor.main.js"}, {type, js}]},
