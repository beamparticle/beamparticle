...
%%% %CopyrightEnd%
%%%-------------------------------------------------------------------
-module(beamparticle_ide_extensions_ws_handler).
-author("neerajsharma").
...
websocket_init(State) ->
    ...
    lager:debug("init beamparticle_ide_extensions_ws_handler websocket"),
    {ok, State}.
...
%% {"jsonrpc":"2.0","id":0,"method":"list","params":{"query":""}}
%% {"jsonrpc":"2.0","id":0,"result":[{"name":"@theia/core","version":"0.3.8","description":"Theia is a cloud & desktop IDE framework implemented in TypeScript.","author":"","installed":true,"outdated":false,"busy":false}, ...]}
run_query(#{<<"id">> := Id,
            <<"method">> := <<"list">>,
